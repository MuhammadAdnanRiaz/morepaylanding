  ...
  return (
    <section className="text-gray-600 w-full overflow-hidden">
      <div className="max-w-7xl px-5 py-24 mx-auto">
        <div className=" mx-auto  flex flex-col-reverse lg:flex-row-reverse flex-wrap justify-center">
          <div className="lg:w-1/2 w-full flex items-center justify-center intersect:animate-fade-up animate-duration-1000 animate-delay-500">
            <img
          ...
          <div className="lg:w-1/2 mb-10 lg:mb-0 w-full max-w-md lg:max-w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 flex flex-col text-left items-start justify-center ">
            ...
            <h1 className="text-gray-900 text-4xl text-left title-font font-bold mb-1 intersect:animate-fade-up animate-duration-1000 animate-delay-500">
              Currency conversion
            </h1>

            <p className="leading-relaxed intersect:animate-fade-up animate-duration-1000 animate-delay-500">
              Convert money from one currency to another on the LemFi app at zero fees.
            </p>
          </div>
        </div>
      </div>

    ...
    return (
        <div className="flex w-full flex-wrap items-center justify-center gap-10">
            <div className="grid w-60 gap-4">
                <svg
                    className="mx-auto text-deep-forest-green-700/70"
                ...
                >
                    ...
                    <rect
                        ...
                        fill="#638605"
                    />
                    <circle cx="42.2582" cy="23.5641" r="1.02564" fill="#638605" />
                    <circle cx="46.3607" cy="23.5641" r="1.02564" fill="#638605" />
                    <circle cx="50.4633" cy="23.5641" r="1.02564" fill="#638605" />
                </svg>
                <div>
                    <h2 className="pb-1 text-center text-base font-semibold leading-relaxed text-black">
                        There’s no bids here
                    </h2>
                    <p className="pb-4 text-center text-sm font-normal leading-snug text-black">
                        Try checking this page again after a while
                    </p>
                </div>
            </div>
        </div>
